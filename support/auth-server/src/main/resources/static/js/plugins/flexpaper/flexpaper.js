...
window.FlexPaperViewerEmbedding = window.$f = function(id, args) {
    ...
    _jsDirectory 		= (config.jsDirectory!=null?config.jsDirectory:"js/plugins/flexpaper");
    _cssDirectory 		= (config.cssDirectory!=null?config.cssDirectory:"css/");
    _localeDirectory 	= (config.localeDirectory!=null?config.localeDirectory:"locale/");
    if(_SWFFile!=null && _SWFFile.indexOf("{" )==0 && _SWFFile.indexOf("[*," ) > 0 && _SWFFile.indexOf("]" ) > 0){_SWFFile = escape(_SWFFile);} // split file fix

    window[instance] = flashembed(id, {
        src						    : "/js/plugins/flexpaper/FlexPaperViewer.swf",
        version					    : [10, 0],
        expressInstall			    : "/js/plugins/flexpaper/expressinstall.swf",
        wmode					    : _WMode
    },{
        ElementId               : id,
        SwfFile  				: _SWFFile,
